...
md_normal = LBSMeshDeformer(vertices, wf)
md_mlp = LBSMeshDeformer(vertices, wfmlp)
md_mlpr = LBSMeshDeformer(vertices, wfmlpr)

body_mesh_normal = trimesh.Trimesh(vertices=md_normal.apply_lbs(frame_poses[0]), faces=faces, vertex_colors=np.tile(colors['grey'], (6890, 1)))
